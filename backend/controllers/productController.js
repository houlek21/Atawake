...
export const createProduct = async (req, res) => {
  ...
  const {
    ...
    category_id,
    is_active = true,
    media_urls = [req.body.media_urls] // Optional array of media URLS
  } = req.body;

  try {
    // check if user is a seller
    console.log(name, description, price, quantity, category_id, is_active, "findcp")
    ...
    console.log(req.user.id, "findcp")
...
export const getProducts = async (req, res) => {
  try {
    ...
    const { category, search, min_price, max_price, sort_by } = req.body;
    console.log('getprod',category)
    // build query filters
    const filters = {
